                    ...
                    <div class="card-body">
                        <div class="dash-widget-header">
                            <div>
                                ...
                                $totalCustomer = $CustomerController->getTotalCustomers();
                                @endphp
                                <h3 class="card_widget_header">{{$totalCustomer }}</h3>
                ...
                <div class="card board1 fill">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            <div>
                                @php
                                $RoomsController = new \App\Http\Controllers\RoomsController();
                                $totalRooms = $RoomsController->getTotalRooms();
                                @endphp
                    ...
                    <div class="card-body">
                        <div class="dash-widget-header">
                            <div>
                                ...
                                $totalBooking = $bookingController->getTotalBooking();
                                @endphp
                    ...
                    <div class="card-body">
                        <div class="dash-widget-header">
                            <div>
                                @php
                                $bookingController = new \App\Http\Controllers\BookingController();
                                $totalRent = $bookingController->getTotalrent();
                                @endphp
                                <h3 class="card_widget_header">$ {{$totalRent}}</h3>
